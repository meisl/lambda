...
{ # - SumType -------------------------------------------------------------------
    ...
    is(Type.Sum($tv1, $tv), $ts1, 'Type.Sum(' ~ $tv1.Str ~ ', ' ~ $tv.Str ~ ') =:= Type.Sum(' ~ $tv.Str ~ ', ' ~ $tv1.Str ~ ')');
    ...
    is(Type.Sum($ts1, $tv), $ts1, 'Type.Sum(' ~ $ts1.Str ~ ', ' ~ $tv.Str ~ ') yields same instance as Type.Sum(' ~ $tv.Str ~ ', ' ~ $ts1.Str ~ ')');
