...
# The latter meaning: by how much it should be advanced in a certain
# situtation (possibly not all).
...
# ...error msg becoming *real* fun now ;)
...
# but first: positive tests, indirect:
...
diag('lives_ok/dies_ok on test code:');
